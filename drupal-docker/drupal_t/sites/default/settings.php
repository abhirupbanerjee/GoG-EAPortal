 ...
 *   'password' => 'lJsWG36jvHrlPrDzejoLaLKosqIU5dl',
 *   'host' => 'localhost',
 *   'port' => '3306',
 *   'driver' => 'mysql',
 *   'prefix' => '',
 ...
 * @endcode
 */
$settings['hash_salt'] = '1RT-g4wwlWKS7MJkr0Dq5R7dk1vrY6YEcbT1b_TgcyzY9kbJecprhawTKs8mUcwK27-fAvvKPg';
...
$databases['default']['default'] = [
  'driver'   => 'mysql',
  'database' => 'drupal',         // must match MYSQL_DATABASE
  'username' => 'drupal',         // must match MYSQL_USER
  'password' => 'lJsWG36jvHrlPrDzejoLaLKosqIU5dl',     // must match MYSQL_PASSWORD
  'host'     => 'db',             // the Docker service name
  'port'     => '3306',
  'prefix'   => '',
  'collation'=> 'utf8mb4_general_ci',
];
$settings['config_sync_directory'] = 'sites/default/files/config_PXANRfLmwYa9J-3WoSnL_QugAWRyqUKTbNHVW_aDN7meJ0CpIsYchyxqi3seU63WiEuNLWAryQ/sync';
